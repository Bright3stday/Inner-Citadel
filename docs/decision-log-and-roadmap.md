...
- Full Inn recovery hub — manual Reduced/Resting per quest, built-in recovery quest sets, condition/neglect protection while resting, a permanent spire repair marker, and rested periods excluded (not counted as misses) in Trends — see Decision Log.
